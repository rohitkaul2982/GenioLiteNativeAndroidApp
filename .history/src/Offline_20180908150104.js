  ...
  render() {
    ...
    return (
        ...
        >
          ...
          <Text style={{fontFamily:'Helvetica-Light',fontSize: 14,color:'#ffffff',marginTop:0,marginBottom:20,marginRight:30,marginLeft:30}}>
              Hi, Device internet seems to be dpwn.Please check your internet connection or try again later.
          </Text>
